...
function DisplayHomePage(req, res, next) {
    return res.render('index', { title: 'Home', page: 'home', displayName: index_1.UserDisplayName(req) });
}
exports.DisplayHomePage = DisplayHomePage;
function DisplayAboutPage(req, res, next) {
    return res.render('index', { title: 'About', page: 'about', displayName: index_1.UserDisplayName(req) });
}
exports.DisplayAboutPage = DisplayAboutPage;
function DisplayServicesPage(req, res, next) {
    return res.render('index', { title: 'Our Services', page: 'services', displayName: index_1.UserDisplayName(req) });
}
exports.DisplayServicesPage = DisplayServicesPage;
function DisplayProjectsPage(req, res, next) {
    return res.render('index', { title: 'Our Projects', page: 'projects', displayName: index_1.UserDisplayName(req) });
}
exports.DisplayProjectsPage = DisplayProjectsPage;
function DisplayContactPage(req, res, next) {
    return res.render('index', { title: 'Contact Us', page: 'contact', displayName: index_1.UserDisplayName(req) });
}
